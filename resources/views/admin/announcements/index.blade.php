<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
            ...
            <a href="{{ route('admin.announcements.create') }}" class="px-5 py-2.5 rounded-xl text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 shadow-sm transition-colors duration-200 inline-block text-center">
                + Tambah Pengumuman
            </a>
        </div>
    </x-slot>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-50 dark:bg-gray-900 border-b border-gray-100 dark:border-gray-700">
                                <th class="p-6 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Judul Pengumuman</th>
                                <th class="p-6 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Isi Ringkas</th>
                                <th class="p-6 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Status</th>
                                <th class="p-6 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Tanggal Publikasi</th>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700 text-sm">
                            @forelse($announcements as $announcement)
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-900/30 transition-colors duration-150">
                                    ...
                                    <!-- Description -->
                                    <td class="p-6 text-gray-500 dark:text-gray-400 max-w-sm truncate">
                                    ...
                                    <td class="p-6 text-right">
                                        <div class="flex items-center justify-end gap-3">
                                            <a href="{{ route('admin.announcements.edit', $announcement->id) }}" class="text-sm font-bold text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300">
                                                Edit
                                            </a>
